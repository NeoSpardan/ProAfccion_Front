...
export function SimpleUserProfile({
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        onClick={onToggle}
        className="w-full flex items-center gap-3 p-3 rounded-md cursor-pointer hover:bg-muted/60 transition-colors focus:outline-none"
      >
        ...
        <div className="absolute right-0 bottom-full mb-1 w-64 rounded-md border bg-popover shadow-lg animate-in fade-in-0 zoom-in-95 z-50">
          ...
          <div className="p-1">
            <Link
              href="/client/datos"
              className={cn(
                "flex items-center gap-3 rounded-sm px-3 py-2.5 text-sm w-full",
            ...
            <Link
              href="/terms"
              className={cn(
                "flex items-center justify-between gap-3 rounded-sm px-3 py-2.5 text-sm w-full",
                "hover:bg-muted transition-colors",
              )}
              onClick={onClose}
            >
            ...
            <button
              ...
              className={cn(
                "flex items-center gap-3 rounded-sm px-3 py-2.5 text-sm w-full text-left",
