    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="overview" className="space-y-4">
        <TabsList className="w-full md:inline-flex md:w-auto overflow-x-auto flex-nowrap justify-start pb-1 mb-1">
          ...
          <TabsTrigger value="reports" className="min-w-[100px]">
            Informes
          </TabsTrigger>
                  ...
                  <div className="flex items-start gap-3 rounded-md p-3 hover:bg-muted/60 transition-colors">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1">
                        ...
                        <p className="text-xs text-muted-foreground whitespace-nowrap">Hace 2 días</p>
                      </div>
                  ...
                  <div className="flex items-start gap-3 rounded-md p-3 hover:bg-muted/60 transition-colors">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1">
                        ...
                        <p className="text-xs text-muted-foreground whitespace-nowrap">Hace 5 días</p>
                      </div>
                      <p className="text-sm text-muted-foreground mt-1 break-words">
                  ...
                  <div className="flex items-start gap-3 rounded-md p-3 hover:bg-muted/60 transition-colors">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1">
                        ...
                        <p className="text-xs text-muted-foreground whitespace-nowrap">Hace 1 semana</p>
                      </div>
                      <p className="text-sm text-muted-foreground mt-1 break-words">
        ...
        <TabsContent value="notifications" className="space-y-4">
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-start gap-4 rounded-md p-2 hover:bg-muted">
